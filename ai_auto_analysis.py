...
class VariableRenamer:
    """
    AI-powered variable renaming system for Ghidra.

    This class analyzes decompiled function code to generate proper function
    variable names with appropriate types. It
    uses AI to determine meaningful variable names and correct C data types.
    """
    ...
    def __init__(
        ...
        # Initialize AI client with variable renaming prompt
        self.ai_client = AzureOpenAIClient(
    ...
    def process_all_variables(self) -> None:
        """
        Generate signatures for all variables in the program.
        """
...
def main() -> None:
    ...
    if should_rename_variables and variable_renamer:
        variable_renamer.process_all_variables()
